(function() {
  var $, FN, MutationObserver, Review, Util, WeakMap, default_escape_fn, getComputedStyle, getComputedStyleRX, render_escape, template_escape, timeSince,
  ...
  $.templ = function(templ) {
    var node;
    return node = $.q("#" + templ + ".ui.template").innerHTML;
  };
  ...
  Review = (function() {
    function Review(data) {
      ...
      this.time = timeSince(new Date(this.timestamp));
    }
    ...
    Review.prototype.render = function() {
      ...
      root.innerHTML = $.render($.templ("review"), this);
      return root;
    };
  ...
  $.getReviews = function(callback) {
    return $.get("reviews.json", function(err, data) {
      var item, _i, _len;
      if (err != null) {
  ...
  $.renderReviews = function() {
    var fragment, review, root, _i, _len, _ref;
    root = $.q(".ui.reviews");
    ...
    return root.appendChild(fragment.cloneNode(true));
  };
